...
var _mathjaxEditorKeyboard = __webpack_require__(3);

var _mathjaxEditorKeyboard2 = _interopRequireDefault(_mathjaxEditorKeyboard);
...
exports.default = _mathjaxEditorKeyboard2.default;
...
var _appendElement = __webpack_require__(0);

var _appendElement2 = _interopRequireDefault(_appendElement);

var _appendElementAfter = __webpack_require__(6);
...
var _removeElement = __webpack_require__(12);

var _removeElement2 = _interopRequireDefault(_removeElement);

var _showElement = __webpack_require__(13);

var _showElement2 = _interopRequireDefault(_showElement);

var _unlistenElement = __webpack_require__(14);
...
var _renderKeyboard = __webpack_require__(16);

var _renderKeyboard2 = _interopRequireDefault(_renderKeyboard);

var _renderControls = __webpack_require__(17);

var _renderControls2 = _interopRequireDefault(_renderControls);
...
var MathJaxEditorKeyboard = function (_MathJaxEditor) {
  _inherits(MathJaxEditorKeyboard, _MathJaxEditor);

  function MathJaxEditorKeyboard(selector, options) {
    ...
    var $keyboard = (0, _createElement2.default)('div', 'mathboard-keyboard');
    var $wrapper = (0, _createElement2.default)('div', 'mathboard-wrapper');

    var currentLayer = 0;
    var isMobile = false;
    var cursorAtDisplay = false;

    (0, _appendElementAfter2.default)($editorContainer, $container);
    (0, _appendElement2.default)($container, $wrapper);
    (0, _appendElement2.default)($wrapper, $editorContainer, $keyboard);
    (0, _hideElement2.default)($keyboard);
    ...
    var renderLayer = function renderLayer() {
      clearKeyboard();
      (0, _renderKeyboard2.default)($keyboard, _layout2.default[currentLayer], _this);
      (0, _renderControls2.default)($keyboard, _this, {
        nextLayer: function nextLayer() {
          if (++currentLayer === _layout2.default.length) {
            currentLayer = 0;
          }
          renderLayer();
        },
        previousLayer: function previousLayer() {
          if (--currentLayer < 0) {
            currentLayer = _layout2.default.length - 1;
          }
          renderLayer();
        }
      });
    ...
    var handleBlur = function handleBlur() {
      //(0, _removeClass2.default)($container, 'is-desktop');
     // (0, _removeClass2.default)($container, 'is-mobile');
      //(0, _hideElement2.default)($keyboard);
      //(0, _hideElement2.default)(_this.core.$caret);
      _this.core.$input.removeAttribute('readonly');
      _this.core.handleBlur();
      (0, _appendElementAfter2.default)(_this.core.$el, $container);
    };
    ...
    var handleResize = function handleResize() {
      ...
      if (width > 512) {
        (0, _addClass2.default)($container, 'is-desktop');
        (0, _removeClass2.default)($container, 'is-mobile');
        $keyboard.style.marginLeft = (0, _px2.default)(-($keyboard.clientWidth / 2));
        _this.core.$input.removeAttribute('readonly');
        isMobile = false;
      } else {
        $keyboard.style.marginLeft = null;
        (0, _appendElement2.default)(document.body, $container);
        (0, _addClass2.default)($container, 'is-mobile');
        (0, _removeClass2.default)($container, 'is-desktop');
        _this.core.$input.setAttribute('readonly', 'true');
        isMobile = true;
      }
    };

    (0, _listenElement2.default)($container, 'click', function (e) {
      if (e.target === $container) {
        handleBlur();
      }
    });

    (0, _listenElement2.default)($container, 'mouseenter', function () {
      cursorAtDisplay = true;
    });

    (0, _listenElement2.default)($container, 'mouseleave', function () {
      cursorAtDisplay = false;
    });

    (0, _listenElement2.default)(document, 'click', handleDocClick);
    _this.on('focus', handleFocus);

    _this.destroy = function () {
      _get(MathJaxEditorKeyboard.prototype.__proto__ || Object.getPrototypeOf(MathJaxEditorKeyboard.prototype), 'destroy', _this).call(_this);
      (0, _removeElement2.default)($container);
      (0, _unlistenElement2.default)(document, 'click', handleDocClick);
    };
    return _this;
  }

  return MathJaxEditorKeyboard;
}(_mathjaxEditor2.default);

exports.default = MathJaxEditorKeyboard;
...
(function webpackUniversalModuleDefinition(root, factory) {
  if (( false ? 'undefined' : _typeof2(exports)) === 'object' && ( false ? 'undefined' : _typeof2(module)) === 'object') module.exports = factory();else if (true) !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));else if ((typeof exports === 'undefined' ? 'undefined' : _typeof2(exports)) === 'object') exports["MathJaxEditor"] = factory();else root["MathJaxEditor"] = factory();
})(undefined, function () {
  return (/******/function (modules) {
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      /* WEBPACK VAR INJECTION */(function (setImmediate) {
        ...
        (function (func, obj) {
          ...
          function is(type, item) {
            return (typeof item === 'undefined' ? 'undefined' : _typeof2(item))[0] == type;
          }
          ...
          function Promise(callback, handler) {
            ...
            handler = function pendingHandler(resolved, rejected, value, queue, then, i) {
              ...
              if (is(func, then)) {
                try {
                  then.call(value, transferState(1), rejected = transferState(0));
                } catch (reason) {
                  rejected(reason);
                }
              }
      ...
      }).call(exports, __webpack_require__(30).setImmediate);
...
exports.default = renderKeyboard;
...
function renderKeyboard($keyboard, layer, editor) {
  layer.forEach(function (line) {
    var $line = (0, _createElement2.default)('div', 'mathboard-line');

    line.forEach(function (key) {
      if (!key) {
        return;
      }
      var $key = (0, _createElement2.default)('button', 'mathboard-key', {
        type: 'button',
        _html: '\\(' + (key[2] || key[1]) + '\\)'
      });
      $key.addEventListener('click', function () {
        switch (key[0]) {
          case 'n':
            return editor.insertNumber(parseInt(key[1]), 10);
          case 'i':
            return editor.insertIdentifier(key[1]);
          case 'o':
            return editor.insertOperator(key[1]);
          case 'm':
            return editor[key[1]]();
        }
      });
      (0, _appendElement2.default)($line, $key);
    });

    (0, _appendElement2.default)($keyboard, $line);
  });
}
...
var _controlsLayout = __webpack_require__(18);

var _controlsLayout2 = _interopRequireDefault(_controlsLayout);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function renderControls($keyboard, editor, mb) {
  var $line = (0, _createElement2.default)('div', 'mathboard-line mathboard-controls');
  _controlsLayout2.default.forEach(function (key) {
    var $key = (0, _createElement2.default)('button', 'mathboard-key', {
...
exports.default = [['pad-left', function (editor) {
  editor.moveCursorLeft();editor.focus();
}], 
['pad-right', function (editor) {
  editor.moveCursorRight();editor.focus();
}], 
['backspace', function (editor) {
  editor.backspaceRemove();editor.focus();
}], 
//['enter', function (editor) {
//  editor.insertNewline();editor.focus();
//}], 
['left', function (editor, mb) {
  mb.previousLayer();
}], 
['right', function (editor, mb) {
  mb.nextLayer();
}]];
...
exports.default = {
  ...
  '.mathboard-line': (_mathboardLine = {
    ...
    '-js-display': 'flex',
    'display': '-webkit-box'
  }, _defineProperty(_mathboardLine, 'display', '-moz-box'), _defineProperty(_mathboardLine, 'display', '-ms-flexbox'), _defineProperty(_mathboardLine, 'display', 'flex'), _defineProperty(_mathboardLine, 'height', '36px'), _defineProperty(_mathboardLine, 'justify-content', 'center'), _defineProperty(_mathboardLine, 'text-align', 'center'), _mathboardLine),
