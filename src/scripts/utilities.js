...
const removeAllFrom = (array, toRemove) => {

    let arr = array.filter( ( el ) => !toRemove.includes( el ) );    
    return arr
}
...
export { getHeight, getRelativeY, listKeyDown, setYValue, splitByNewLines, createTspansArray, splitLines, fitFontToSpace, contains, isIterable, getFromLocalStorage, saveToLocalStorage, removeFromIndex, removeFrom, moveTo, sample, shuffle, uniq, startCase, speedyTemplate, range, makeId, removeFromLocalStorage, removeAllFrom, titleCase };
